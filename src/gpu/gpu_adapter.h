...
struct GPUAdapter
{
	...
	virtual GPU::DeviceID device_create(GPU::PhysicalDeviceID physical_device, const GPU::DeviceCreateInfo& ci) = 0;
	virtual void device_destroy(GPU::DeviceID device) = 0;

	virtual GPU::SwapChainID swap_chain_create(GPU::DeviceID device, const GPU::SwapChainCreateInfo& ci) = 0;
	...
	virtual GPU::FenceID fence_create(GPU::DeviceID device, const GPU::FenceCreateInfo& ci) = 0;
	...
	virtual GPU::SemaphoreID semaphore_create(GPU::DeviceID device, const GPU::SemaphoreCreateInfo& ci) = 0;
	virtual void semaphore_destroy(GPU::SemaphoreID semaphore) = 0;

	virtual u32 queue_get_count(GPU::DeviceID device, const GPU::QueueGetCountInfo& gci) = 0;
	virtual GPU::QueueID queue_get(GPU::DeviceID device, const GPU::QueueGetInfo& gi) = 0;
	...
	virtual GPU::MemoryHeapID memory_heap_create(GPU::DeviceID device, const GPU::MemoryHeapCreateInfo& ci) = 0;
	...
	virtual GPU::BufferID buffer_create(GPU::DeviceID device, const GPU::BufferCreateInfo& ci) = 0;
	...
	virtual GPU::SamplerID sampler_create(GPU::DeviceID device, const GPU::SamplerCreateInfo& ci) = 0;
	virtual void sampler_destroy(GPU::SamplerID sampler) = 0;

	virtual GPU::TextureID texture_create(GPU::DeviceID device, const GPU::TextureCreateInfo& ci) = 0;
	...
	virtual GPU::TextureViewID texture_view_create(GPU::DeviceID device, const GPU::TextureViewCreateInfo& ci) = 0;
	virtual void texture_view_destroy(GPU::TextureViewID texture_view) = 0;

	virtual GPU::DescriptorSetLayoutID descriptor_set_layout_create(GPU::DeviceID device, const GPU::DescriptorSetLayoutCreateInfo& ci) = 0;
	...
	virtual void descriptor_set_update_descriptors(GPU::DeviceID device, const GPU::UpdateDescriptorInfo& update_info) = 0;

	virtual GPU::PipelineLayoutID pipeline_layout_create(GPU::DeviceID device, const GPU::PipelineLayoutCreateInfo& ci) = 0;
	virtual void pipeline_layout_destroy(GPU::PipelineLayoutID pipeline_layout) = 0;

	virtual GPU::PipelineID pipeline_create(GPU::DeviceID device, const GPU::PipelineCreateInfo& ci) = 0;
	...
	virtual void command_buffer_bind_descriptor_sets(GPU::CommandBufferID command_buffer, GPU::PipelineBindPoint bind_point, GPU::PipelineLayoutID pipeline_layout, u32 base_set, const Slice<const GPU::DescriptorSetID>& descriptor_sets) = 0;
	virtual void command_buffer_bind_vertex_buffers(GPU::CommandBufferID command_buffer, u32 base_binding, const Slice<const GPU::BufferID>& buffers, const Slice<const usize>& offsets) = 0;
