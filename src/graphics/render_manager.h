...
struct RenderManager
{
    ...
    [[nodiscard]] static RenderItem& _get_item(RenderItemID render_item_id);
    ...
    static void item_set_material(RenderItemID render_item_id, MaterialID material);
    static MaterialID item_get_material(RenderItemID render_item_id);
    ...
    static void render_item_draw_sprite(RenderItemID render_item_id, const Transform2D& transform, TextureID texture,
        const Rect2D& rect, const Rect2D& src_rect, Color mod_color, RenderFlags flags);

    static void render_item_draw_ui_sprite(RenderItemID render_item_id, const Transform2D& transform, TextureID texture,
        const Rect2D& rect, const Rect2D& src_rect, Color mod_color, RenderFlags flags);
};