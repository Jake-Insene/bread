...
* new/delete and their variants must be avoided; their usage will trigger a debugbreak() ([see](../src/Main.cpp)).
...
* We use a more explicit approach where paths can be easily drawn. The engine will still provide collections that let you use OOP easily.
